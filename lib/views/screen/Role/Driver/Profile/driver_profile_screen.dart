                        ...
                        child: Center(
                          child: Column(
                            children: [
                              ...
                              CustomNetworkImage(
                                imageUrl:
                                    '${ApiConstants.imageBaseUrl}${_profileController.profileModel.value.image}',
                                height: 135.h,
                                width: 135.w,
                              ...
                              CustomText(
                                text:
                                    '${_profileController.profileModel.value.userName}',
                                fontWeight: FontWeight.w600,
                                fontSize: 20.sp,
                              ),
                              SizedBox(height: 12.h),
                              Row(
                                ...
                                children: [
                                  CustomText(
                                    text:
                                        '${_profileController.profileModel.value.totalRatings}',
                                  ),
                                  SizedBox(width: 8.w),
                              ...
                              CustomListTile(
                                onTap: () {
                                  Get.toNamed(
                                    AppRoutes.driverPersonalInformationScreen,
                                  );
                                },
